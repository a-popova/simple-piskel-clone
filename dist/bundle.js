...
/***/ "./src/javascript/animation-preview/fullScreen.js":
/*!********************************************************!*\
  !*** ./src/javascript/animation-preview/fullScreen.js ***!
  \********************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar getFrames = function getFrames() {\n  var frames = document.querySelectorAll('.frame');\n  return frames;\n};\n\nvar count = 0;\n\nfunction draw(frame) {\n  var preview = document.getElementById('preview');\n  var ctx = preview.getContext('2d');\n  var canvasSize = localStorage.getItem('canvasSize');\n  var imageURL = frame.toDataURL();\n  var img = new Image();\n  img.src = imageURL;\n\n  img.onload = function () {\n    ctx.clearRect(0, 0, canvasSize, canvasSize);\n    ctx.drawImage(img, 0, 0, canvasSize, canvasSize);\n  };\n}\n\nvar lastFrame = 0;\n\nvar startAnimation = function startAnimation(currentTime) {\n  var slider = document.getElementById('myRange');\n  var currentFPS = slider.value;\n  var intervalForFrame = 1000 / currentFPS;\n\n  if (currentTime - lastFrame > intervalForFrame) {\n    var frames = getFrames();\n    var frame = frames[count % frames.length];\n    draw(frame);\n    count += 1;\n    lastFrame = currentTime;\n  }\n\n  requestAnimationFrame(startAnimation);\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (startAnimation);\n\n//# sourceURL=webpack:///./src/javascript/animation-preview/preview.js?");

/***/ }),

/***/ "./src/javascript/frames/add.js":
/*!**************************************!*\
  !*** ./src/javascript/frames/add.js ***!
  \**************************************/
/*! exports provided: addFrame, handleFrame */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addFrame\", function() { return addFrame; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleFrame\", function() { return handleFrame; });\nfunction addFrame() {\n  var frames = document.querySelectorAll('.frame');\n  var items = document.querySelectorAll('.item');\n  var lastItem = items[items.length - 1];\n  var canvas = document.getElementById('canvas');\n  var ctx = canvas.getContext('2d');\n  var canvasSize = localStorage.getItem('canvasSize');\n\n  if (frames.length < 4) {\n    ctx.fillStyle = '#ffffff';\n    ctx.fillRect(0, 0, canvasSize, canvasSize);\n    frames.forEach(function (frame) {\n      return frame.classList.remove('active');\n    });\n    var newFrame = lastItem.cloneNode(true);\n    newFrame.firstElementChild.classList.add('active');\n    lastItem.after(newFrame);\n  }\n}\n\nfunction handleFrame(element) {\n  if (element.classList.contains('active')) {\n    return;\n  }\n\n  var canvas = document.getElementById('canvas');\n  var ctx = canvas.getContext('2d');\n  var canvasSize = localStorage.getItem('canvasSize');\n  var frames = document.querySelectorAll('.frame');\n  frames.forEach(function (frame) {\n    return frame.classList.remove('active');\n  });\n  element.classList.add('active');\n  var imageURL = element.toDataURL();\n  var img = new Image();\n  img.src = imageURL;\n\n  img.onload = function () {\n    ctx.drawImage(img, 0, 0, canvasSize, canvasSize);\n  };\n}\n\n\n\n//# sourceURL=webpack:///./src/javascript/frames/add.js?");

/***/ }),

/***/ "./src/javascript/frames/delete.js":
/*!*****************************************!*\
  !*** ./src/javascript/frames/delete.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction setActiveFrame() {\n  var canvas = document.getElementById('canvas');\n  var ctx = canvas.getContext('2d');\n  var canvasSize = localStorage.getItem('canvasSize');\n  var frames = document.querySelectorAll('.frame');\n  frames.forEach(function (frame) {\n    return frame.classList.remove('active');\n  });\n  var frame = document.querySelector('.frame');\n  frame.classList.add('active');\n  var imageURL = frame.toDataURL();\n  var img = new Image();\n  img.src = imageURL;\n\n  img.onload = function () {\n    ctx.drawImage(img, 0, 0, canvasSize, canvasSize);\n  };\n}\n\nfunction deleteFrame(element) {\n  var deleteFrameButtons = document.querySelectorAll('button[name=delete]');\n\n  if (deleteFrameButtons.length > 1) {\n    element.remove();\n  }\n\n  setActiveFrame();\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (deleteFrame);\n\n//# sourceURL=webpack:///./src/javascript/frames/delete.js?");

/***/ }),

/***/ "./src/javascript/frames/duplicate.js":
/*!********************************************!*\
  !*** ./src/javascript/frames/duplicate.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction duplicateFrame(element) {\n  var clickedElem = element;\n  var imageURL = clickedElem.firstElementChild.toDataURL();\n  var frames = document.querySelectorAll('.frame');\n  var canvas = document.getElementById('canvas');\n  var ctx = canvas.getContext('2d');\n  var canvasSize = localStorage.getItem('canvasSize');\n\n  if (frames.length < 4) {\n    frames.forEach(function (frame) {\n      return frame.classList.remove('active');\n    });\n    var newFrame = clickedElem.cloneNode(true);\n    newFrame.firstElementChild.classList.add('active');\n    clickedElem.after(newFrame);\n    var canvasFrame = newFrame.firstElementChild;\n    var ctxCanvasFrame = canvasFrame.getContext('2d');\n    var img = new Image();\n    img.src = imageURL;\n\n    img.onload = function () {\n      ctxCanvasFrame.drawImage(img, 0, 0, canvasSize, canvasSize);\n      ctx.drawImage(img, 0, 0, canvasSize, canvasSize);\n    };\n  }\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (duplicateFrame);\n\n//# sourceURL=webpack:///./src/javascript/frames/duplicate.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return modalHandle; });\nfunction modalHandle() {\n  var buttonKeyboard = document.querySelector('.keyboard');\n  var modal = document.getElementById('modal');\n  var span = document.getElementsByClassName('close')[0];\n  var element;\n  var isClicked = false;\n  var clickedKey = document.querySelectorAll('.modal-body li span:nth-child(2)');\n\n  function highlightShortcut(clickedElement) {\n    element = clickedElement;\n    isClicked = true;\n    element.style.color = 'gray';\n    element.style.borderStyle = 'dashed';\n  }\n\n  clickedKey.forEach(function (key) {\n    return key.addEventListener('click', function (event) {\n      return highlightShortcut(event.target);\n    });\n  });\n\n  function changeShortcut(event) {\n    if (isClicked) {\n      var key = document.querySelector(\"span[data-code=\".concat(event.code, \"]\"));\n\n      if (key) {\n        window.alert(\"This shortcut already exists. Please, select another one!\");\n        return;\n      }\n\n      var keyValueString = event.code.toString();\n      var keyValue = keyValueString.slice(keyValueString.length - 1);\n      element.innerHTML = keyValue;\n      element.setAttribute('data-code', event.code);\n      element.style.color = 'white';\n      element.style.borderStyle = 'solid';\n      isClicked = false;\n    }\n  }\n\n  document.body.addEventListener('keypress', function (event) {\n    changeShortcut(event);\n  });\n\n  buttonKeyboard.onclick = function () {\n    modal.style.display = 'block';\n  };\n\n  span.onclick = function () {\n    modal.style.display = 'none';\n  };\n\n  window.onclick = function (event) {\n    if (event.target === modal) {\n      modal.style.display = 'none';\n    }\n  };\n}\n\n//# sourceURL=webpack:///./src/javascript/keyboard/modal.js?");

/***/ }),

/***/ "./src/javascript/keyboard/shortcuts.js":
/*!**********************************************!*\
  !*** ./src/javascript/keyboard/shortcuts.js ***!
  \**********************************************/
/*! exports provided: handleShortcut */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleShortcut\", function() { return handleShortcut; });\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index */ \"./src/javascript/index.js\");\n\n\n\nfunction handleShortcut(keyCode) {\n  var key = document.querySelector(\"span[data-code=\".concat(keyCode, \"]\"));\n\n  if (key) {\n    var element = key.classList[2];\n    _index__WEBPACK_IMPORTED_MODULE_0__[\"default\"][element]();\n  }\n}\n\n\n\n//# sourceURL=webpack:///./src/javascript/keyboard/shortcuts.js?");
